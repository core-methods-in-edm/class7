...
```{r}
data_wide <- read.table("E:/TC/4050/GITHUB/class7/instructor_activity_wide.csv", sep = ",", header = TRUE)
...
```{r}
student_data <- read.table("E:/TC/4050/GITHUB/class7/student_activity.csv", sep = ",", header = TRUE)
