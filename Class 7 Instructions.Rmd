...
```{r}
data_wide <- read.table("~/Documents/EDM/class7/instructor_activity_wide.csv", sep = ",", header = TRUE)
...
```{r}
data_student <- read.table("~/Documents/EDM/class7/student_activity.csv", sep = ",", header = TRUE)
